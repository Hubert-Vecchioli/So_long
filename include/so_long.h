...
/*   Updated: 2024/06/19 16:10:45 by hvecchio         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
typedef struct s_fix_game_images
{
	...
	t_image	collectible;
	t_image	enemy;
	t_image	enemy_animated;
	t_image	exit_open;	
	t_image	exit_closed;
	int		enemy_to_display;
	int		enemy_speed;
}	t_fix_game_images;
...
void		ft_render_sprite(t_game *game, t_image sprite,
				int line, int column);
...
void		ft_flood_map(t_game *game, char **content_copy,
				int pos_x, int pos_y);
